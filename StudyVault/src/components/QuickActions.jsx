    ...
    <div>
      ...
      <div className='grid grid-cols-3 gap-4'>
        <button
          ...
          className='bg-blue-600 hover:bg-blue-800 text-white rounded-xl p-6 text-left transition-all transform hover:scale-105 shadow-md'>
        ...
        <button
          ...
          className='bg-purple-600 hover:bg-purple-800 text-white rounded-xl p-6 text-left transition-all transform hover:scale-105 shadow-md'>
        ...
        <button
          ...
          className='bg-green-600 hover:bg-green-800 text-white rounded-xl p-6 text-left transition-all transform hover:scale-105 shadow-md'>
